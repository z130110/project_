...
from dc_cleanpagelocation_more_than_5000 import CleanPageLocation
...
class DC(object):
    ...
    def take_only_page(self,page_df):
        return page_df.select("sessionnumber","pagelocation","eventtimestamp")\
    ...
    def join_cp_target(self,cp_df,target_df,useragent_df):
        ...
        return cp_df.join(target_user_agent, target_user_agent.sessionnumber == cp_df.sessionnumber,"inner")\
                    .select(cp_df.sessionnumber, "pagelocation","target","aftlnr","browser","os","eventtimestamp")
