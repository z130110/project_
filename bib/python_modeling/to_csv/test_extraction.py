...
def save_csv_to_np(data_dir, file_name, percent_to_read = 1.0):
    save_dir = "/data/numpy_conversions/test_extraction/test_extraction"
...
def features(data_dir, file_name, percent_to_read):
    ...
    res_np = dl.to_numpy([dl.csv_data_dict["sessionstarttime_weekday"], \
                          dl.csv_data_dict["sessionstarttime_hour"], \
                          os, \
                          browser, \
                          dl.csv_data_dict["combined_pagelocation"], \
                          dl.csv_data_dict["combined_eventtimestamp"], \
