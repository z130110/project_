...
,sessionnumber,devicebrowsername,deviceplatformname,devicesystemname,page_flow,time_list,target,browser_indexer,
      platform_indexer,OS_indexer,word_vector_pagelist
