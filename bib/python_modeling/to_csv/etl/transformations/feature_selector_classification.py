...
import sys
sys.path.insert(0, "/home/Workdir/bib/konstanter")
...
class FeatureSelector(object):
    def __init__(self, folder, filename):
        self.data = CsvReader(folder, filename = filename).run()
        self.data["target"] = convert_target_to_class(self.data["target"]
