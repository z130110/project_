...
class DSRawDataExtraction:
    ...
    def raw_data_filtered(self):
        ...
        res = final_targets_corrected \
            .orderBy(final_targets_corrected.target) \
            .groupBy(final_targets_corrected.sessionnumber) \
            .agg(func.first(final_targets_corrected.aftlnr).alias("aftlnr")
                , func.first(final_targets_corrected.knid).alias("knid") \
                , func.first(final_targets_corrected.target).alias("target"))
